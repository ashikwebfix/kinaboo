...
const products = [
  ...
  // PHOTOGRAPHY (4)
  {
    ...
    price: 1499.00,
    sellPrice: 1399.00,
    description: 'A professional-grade full-frame mirrorless camera offering 45 Megapixels, 8K video recording, and advanced subject tracking autofocus. Perfect for hybrid shooters who demand the best in both photography and videography.',
    image: 'https://images.unsplash.com/photo-1516035069371-29a1b244cc32?q=80&w=2000&auto=format&fit=crop',
    images: [
    ...
    longDescription: "<h1>The Ultimate Creative Tool</h1><p>Whether you are shooting high-fashion portraits or cinematic documentaries, the Lumina X1 delivers uncompromising image quality. Its revolutionary autofocus system locks onto eyes, faces, and animals with terrifying precision.</p><h2>Robust and Reliable</h2><p>Constructed from magnesium alloy and heavily weather-sealed, it is built to withstand the harshest shooting conditions.</p><h2>Unmatched 8K Video</h2><p>Record stunning 8K RAW video internally. The immense resolution gives you unparalleled flexibility in post-production, allowing you to crop, pan, and zoom without losing 4K detail.</p><h2>Next-Gen Image Stabilization</h2><p>The 5-axis In-Body Image Stabilization works in tandem with stabilized lenses to provide up to 8 stops of shake correction, making handheld low-light shooting a breeze.</p>",
    faq: [
